...
{Total variation} 
{全变差}
\NewTerm[no acronym] {AbsolutelyContinuous} 
{absolutely continuous} 
{绝对连续}
\NewTerm[no acronym] {MutuallySingular} 
{mutually singular} 
{相互奇异}
\NewTerm[no acronym] {ProductSpace} 
{product space} 
{乘积空间}
\NewTerm[no acronym] {FiniteDimensionalRectangularCylinderSet} 
{finite-dimensional rectangular cylinder set} 
{有限维可测矩形柱集}
