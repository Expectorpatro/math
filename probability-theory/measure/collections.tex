...
\begin{property}\label{prop:SetOperation}
	...
	\begin{enumerate}
		...
		\item \textbf{分配律：}
		\begin{gather*}
			A\cap\left(\underset{n\in I}{\overset{}{\bigcup}}A_n\right)=\underset{n\in I}{\overset{}{\bigcup}}(A\cap A_n),\quad A\cup\left(\underset{n\in I}{\overset{}{\bigcap}}A_n\right)=\underset{n\in I}{\overset{}{\bigcap}}(A\cup A_n) \\
...
\begin{proof}
	...
	\textbf{b：}由\cref{theo:duality between openset and closed set}可知开集的补集是闭集，闭集的补集是开集，根据sigma运算即可得到$\sigma(\mathcal{D})=\sigma(\mathcal{O})=\mathcal{B}$。\par
	\textbf{cde：}仅给出构造公式，利用这些公式和sigma运算即可得出所有的结论。注意到c的1和3是补集的关系，2和4也是补集的关系，所以只需证明1和2。
	\begin{gather*}
...
\end{theorem}
\begin{proof}
	下给出构造公式，利用\cref{prop:BorelSigmaField}(1)和sigma运算即可得出结论。注意到1和4是补集的关系，2和3也是补集的关系，所以只需证明1和2。
	\begin{gather*}
