...
\begin{proof}
	...
	\begin{equation*}
		0\leqslant\varphi^{\star}(A\backslash B)\leqslant\varphi^{\star}(A)=0
	\end{equation*}
	所以$\varphi^{\star}(A\backslash B)=0,\;A\backslash B\in\mathscr{A}$。\par
...
\begin{lemma}
	...
	\begin{enumerate}
		\item 若$A\in\mathscr{F}$且$\varphi(A)<+\infty$，则对任意的$\varepsilon>0$，存在$B\in\mathscr{F}$满足$B\subseteq A,\varphi(B)\geqslant0$且$\varphi^{\star}(A\backslash B)\leqslant\varepsilon$；
		\item 若$A\in\mathscr{F}$且$\varphi(A)<0$，则存在$B\in\mathscr{F}$满足$B\subseteq A,\;\varphi(B)<0$且$\varphi^{\star}(B)=0$。
	\end{enumerate}
\end{lemma}
\begin{proof}
	(1)若此时不满足结论，即存在$\varepsilon>0$，对于任意的$B\subseteq A$都有$\varphi(B)<0$或$\varphi^{\star}(A\backslash B)>\varepsilon$。取$B=\varnothing$即可排除$\varphi(B)<0$，即此时必须有$\varphi^{\star}(A\backslash B)>\varepsilon$。取$B_0=\varnothing$，根据归纳假设可得$\varphi^{\star}(A\backslash B_0)=\varphi^{\star}(A)>\varepsilon$，由$\varphi^{\star}$的定义可知存在$B_1\in\mathscr{F}$满足$B_1\subseteq A\backslash B_0=A$且$\varphi(B_1)>\varepsilon$。根据归纳假设，因为$B_1\subseteq A$，所以有$\varphi^{\star}(A\backslash B_1)>\varepsilon$，即存在$B_2\in\mathscr{F}$满足$B_2\subseteq A\backslash B_1\subseteq A$且$\varphi(B_2)>\varepsilon$。根据归纳假设，因为$B_1\cup B_2\subseteq A$，所以有$\varphi^{\star}[A\backslash(B_1\cup B_2)]>\varepsilon$，即存在$B_3\in\mathscr{F}$满足$B_3\subseteq A\backslash(B_1\cup B_2)\subseteq A$且$\varphi(B_3)>\varepsilon$。继续操作下去，可以得到互不相交的集合序列$\{B_n\}$满足：
	\begin{equation*}
	...
	(2)由(1)可知存在$B_1\subseteq A$满足$\varphi(B)\geqslant0$且$\varphi^{\star}(A\backslash B)\leqslant1$。根据$\varphi^{\star}$的定义可得：
	\begin{equation*}
		\varphi(A\backslash B_1)\leqslant\varphi^{\star}(A\backslash B_1)\leqslant1
	\end{equation*}
	所以存在$B_2\subseteq A\backslash B_1$满足$\varphi(B)\geqslant0$且$\varphi^{\star}[A\backslash (B_1\cup B_2)]\leqslant\frac{1}{2}$。继续操作下去，可以得到互不相交的集合序列$\{B_n\}\subseteq\mathscr{F}$满足：
	\begin{equation*}
	...
	\begin{equation*}
		\varphi(B)=\sum_{n=1}^{+\infty}\varphi(B_n)\geqslant0,\quad0\leqslant\varphi^{\star}(A\backslash B)\leqslant\varphi^{\star}\left[A\Big\backslash\left(\underset{i=1}{\overset{n}{\cup}}B_n\right)\right]\leqslant\frac{1}{n}
	\end{equation*}
	所以$\varphi^{\star}(A\backslash B)=0$。取$A_0=A\backslash B$，根据\cref{prop:SigmaField}(4)可得：
	\begin{equation*}
...
\begin{proof}
	...
	\end{equation*}
	所以$X^-$满足要求。\par
	令$X^+=X\backslash X^-$，则$X^+\cup X^-=X$。由\cref{prop:SigmaField}(4)可知$X^+\in\mathscr{F}$。若存在$A\in\mathscr{F}$使得$\varphi(A\cap X^+)$\info{未完成}
\end{proof}
