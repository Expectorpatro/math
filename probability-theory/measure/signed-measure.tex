...
\begin{proof}
	...
	\end{align*}
\end{proof}
\begin{property}\label{prop:RandonNikodym}
...
\begin{proof}
	...
	\begin{equation*}
		\frac{\dif(\varphi+\psi)}{\dif\mu}=\frac{\dif\varphi}{\dif\mu}+\frac{\dif\psi}{\dif\mu}\;\text{a.e.于}(X,\mathscr{F},\mu)
	\end{equation*}\par
	(5)对任意的$A\in\mathscr{F}$，由\cref{theo:RandonNikodym}、\cref{prop:MeasurableFunction}(5.c)和\cref{lem:IntChangeOfMeasure}可得：
	\begin{equation*}
		\int_{A}\frac{\dif\varphi}{\dif\mu}\Big/\frac{\dif\psi}{\dif\mu}\dif\psi=\int_{A}\frac{\dif\varphi}{\dif\mu}\Big/\frac{\dif\psi}{\dif\mu}\frac{\dif\psi}{\dif\mu}\dif\mu=\int_{A}\frac{\dif\varphi}{\dif\mu}\dif\mu=\varphi(A)
	\end{equation*}
	根据\cref{theo:RandonNikodym}可得：
	\begin{equation*}
