...
\begin{property}\label{prop:Expectation}
	...
	\begin{enumerate}
		...
		\begin{equation*}
			\operatorname{E}\left[\prod_{i=1}^{n}g_i(f_i)\right]=\prod_{i=1}^{n}\operatorname{E}[g_i(f_i)]
		\end{equation*}
		之一有意义，二者一定相等。
	\end{enumerate}
\end{property}
\begin{proof}
	(1)由\cref{prop:MeasurableMapping}(2)可知$g\circ f$是$(X,\mathscr{F},P)$到$(\mathbb{R}^{},\mathcal{B})$上的可测函数。注意到：
	\begin{equation*}
...
\begin{definition}
	...
	\begin{equation*}
		\varphi(A)=\int_{A}f(x)\dif P
	\end{equation*}
	因为概率是$\sigma$有限测度，由\cref{prop:Measure}(4)、\cref{lem:ConditionalExpectation}(1)、\cref{prop:SignedMeasure}(7)、\cref{lem:ConditionalExpectation}(2)和\cref{theo:RandonNikodym}可知存在$(X,\mathscr{A},P)$上a.s.于$X$的意义下唯一的在$X$上积分存在的可测函数$\operatorname{E}(f|\mathscr{A})$满足：
	\begin{equation*}
...
\begin{property}\label{prop:ConditionalExpectation}
	...
	\begin{enumerate}
		\item $f$关于$\mathscr{A}$可测的充要条件为$\operatorname{E}(f|\mathscr{A})=f\;$a.s.于$(X,\mathscr{A},P)$；
		...
		\item 若$\mathscr{A}\subseteq\mathscr{B}$，则$\operatorname{E}[\operatorname{E}(f|\mathscr{A})|\mathscr{B}]=\operatorname{E}(f|\mathscr{A})\;$a.s.于$(X,\mathscr{B},P)$，$\operatorname{E}[\operatorname{E}(f|\mathscr{B})|\mathscr{A}]=\operatorname{E}(f|\mathscr{A})\;$a.s.于$(X,\mathscr{A},P)$，$\operatorname{E}[\operatorname{E}(f|\mathscr{A})]=\operatorname{E}(f)$；
 		\item 若$f\leqslant g\;$a.s.于$(X,\mathscr{A},P)$，则$\operatorname{E}(f|\mathscr{A})\leqslant\operatorname{E}(g|\mathscr{A})\;$a.s.于$(X,\mathscr{A},P)$；
		...
		\end{equation*}
		a.s.于$(X,\mathscr{A},P)$；
		\item 若$0\leqslant f_n\uparrow f\;$a.s.于$(X,\mathscr{A},P)$，则$0\leqslant\operatorname{E}(f_n|\mathscr{A})\uparrow \operatorname{E}(f|\mathscr{A})\;$a.s.于$(X,\mathscr{A},P)$；
		\item 若$f_n\geqslant0\;$a.s.于$(X,\mathscr{F},P)$，则$\operatorname{E}\left(\varliminf\limits_{n\to+\infty}f_n\Big|\mathscr{A}\right)\leqslant\varliminf\limits_{n\to+\infty}\operatorname{E}(f_n|\mathscr{A})\;$a.s.于$(X,\mathscr{A},P)$；
		\item 若$|f_n|\leqslant g\in L_1(X,\mathscr{A},P)$且$f_n\overset{\text{a.s.}}{\longrightarrow}f$，则$\lim\limits_{n\to+\infty}\operatorname{E}(f_n|\mathscr{A})=\operatorname{E}(f|\mathscr{A})\;$a.s.于$(X,\mathscr{A},P)$。
	\end{enumerate}
\end{property}
\begin{proof}
	...
	\end{align*}
	于是结论成立。\par
	(3)由$\operatorname{E}(f|\mathscr{A})$的定义可知$\operatorname{E}(f|\mathscr{A})$是$\mathscr{A}$可测的，因为$\mathscr{A}\subseteq\mathscr{B}$，所以$\operatorname{E}(f|\mathscr{A})$是$\mathscr{B}$可测的。由(1)可得$\operatorname{E}[\operatorname{E}(f|\mathscr{A})|\mathscr{B}]=\operatorname{E}(f|\mathscr{A})\;$a.s.于$(X,\mathscr{B},P)$。\par
	...
	\end{equation*}
	由\cref{prop:NonnegativeMeasurableIntegral}(9)可得$P(E)=0$，即$\operatorname{E}(f|\mathscr{A})\leqslant\operatorname{E}(g|\mathscr{A})\;$a.s.于$(X,\mathscr{A},P)$。\par
	...
	\end{equation*}
	a.s.于$(X,\mathscr{A},P)$。根据\info{可列个可列是可列}和\cref{prop:Measure}(3)（次可列可加性）即可得出结论。\par
	(7)因为$f_n\geqslant0\;$a.s.于$(X,\mathscr{A},P)$，所以：
	\begin{equation*}
		0\leqslant\inf_{i\geqslant n}f_i\uparrow\lim_{n\to+\infty}\inf\limits_{i\geqslant n}f_i\;\text{a.s.于}(X,\mathscr{A},P)
	\end{equation*}
	...
	\end{equation*}
	a.s.于$(X,\mathscr{A},P)$。根据(6)、\cref{prop:RSeq}(6)、\cref{prop:SigmaField}(3)和\cref{prop:Measure}(3)（次有限可加性）可得：
	\begin{align*}
...
\end{theorem}
\begin{proof}
	当$f\geqslant0\;$a.s.于$(X,\mathscr{A},P)$上时，使用典型方法。\par
	...
	\end{align*}
	所以结论对非负简单函数成立。\par
	当$g$是非负随机变量时，由\cref{prop:MeasurableFunction}(8)可知存在非负简单函数列$\{g_n\}$满足$g_n\uparrow g$，于是$fg_n\uparrow fg$且$fg_n\geqslant0\;$a.s.于$(X,\mathscr{A},P)$。根据\cref{prop:RSeq}(8.c)、\cref{prop:ConditionalExpectation}(6)和非负简单函数时的情况可得：
	\begin{equation*}
	...
	\end{align*}
	存在。由\cref{prop:ConditionalExpectation}(5)和$f\geqslant0\;$a.s.于$(X,\mathscr{A},P)$时的情况可得：
	\begin{align*}
