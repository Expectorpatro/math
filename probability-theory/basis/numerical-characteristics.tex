...
\begin{definition}
	...
	\end{equation*}
	为事件$A\in\mathscr{F}$关于$\mathscr{A}$的\gls{ConditionalProbability}和事件$A\in\mathscr{F}$关于$g$的条件概率（$I_A$在$X$上积分存在）。当给定多个子$\sigma$域$\mathscr{A}_1,\mathscr{A}_2,\dots,\mathscr{A}_n\subseteq\mathscr{F}$时，约定：
	\begin{equation*}
