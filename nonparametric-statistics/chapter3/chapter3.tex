...
\end{enumerate}
\input{nonparametric-statistics/chapter3/kruskal-wallis}
\input{nonparametric-statistics/chapter3/jt}
\input{nonparametric-statistics/chapter3/friedman-test}
\input{nonparametric-statistics/chapter3/page}
\input{nonparametric-statistics/chapter3/cochran}
\input{nonparametric-statistics/chapter3/durbin}