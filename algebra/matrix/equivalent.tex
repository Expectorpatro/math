...
\begin{proof}
	...
	\end{equation*}\par
	(4)由\cref{prop:OrthogonalProjectionMat}(2)可知$A(A^{\top}A)^-A^{\top}$是向$\mathcal{M}(A)$的正交投影阵，由\cref{prop:ProjectionTransformation}(5)和\cref{theo:LinearTransformationMatrix}可得$A(A^{\top}A)^-A$是唯一的，与$(A^{\top}A)^-$的选择无关。\par
	(5)此时有：
	\begin{equation*}
