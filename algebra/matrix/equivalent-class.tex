...
\begin{proof}
	...
	(4)因为$A\cong B$，所以存在可逆矩阵$C$使得$C^TAC=B$，于是由\cref{prop:InvertibleMatrix}(14)和\cref{prop:MatrixRank}(2)可知$\operatorname{rank}(A)=\operatorname{rank}(B)$，而对角矩阵的秩就等于对角线上非零元素的个数，所以结论成立。\par
