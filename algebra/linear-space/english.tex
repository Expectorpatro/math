...
{最大公因式}
\NewTerm[no acronym] {Coprime}
{coprime}
{互素}
\NewTerm[no acronym] {IrreduciblePolynomial}
{irreducible polynomial}
{不可约多项式}
\NewTerm[no acronym] {KFoldFactor}
{k-fold factor}
{k重因式}
\NewTerm[no acronym] {SimpleFactor}
{simple factor}
{单因式}
\NewTerm[no acronym] {MultipleFactor}
{multiple factor}
{重因式}
...
{几何重数}
\NewTerm[no acronym] {AnnihilatingPolynomial}     
{annihilating polynomial}    
{零化多项式}
\NewTerm[no acronym] {MinimalPolynomial}     
{minimal polynomial}    
{最小多项式}
\NewTerm[no acronym] {JordanBlock}     
{Jordan block}    
{Jordan块}
\NewTerm[no acronym] {MatrixInJordanForm}     
