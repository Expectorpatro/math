...
\begin{property}\label{prop:RSeq}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			\item 设$\{x_n\},\{y_n\},\{z_n\}\subseteq\mathbb{R}^{}$，存在$N\in\mathbb{N}^+$使得当$n>N$时有$x_n\leqslant y_n\leqslant z_n$，若$\lim\limits_{n\to+\infty}x_n=\lim\limits_{n\to+\infty}z_n=a$，则$\lim\limits_{n\to+\infty}y_n=a$；
			\item 设$\{x_n\},\{y_n\}\subseteq\mathbb{R}^{}$，存在$N\in\mathbb{N}^+$使得当$n>N$时有$y_n>x_n$，若$\lim\limits_{n\to+\infty}x_n=+\infty$，则$\lim\limits_{n\to+\infty}y_n=+\infty$；
			\item 设$\{x_n\},\{y_n\}\subseteq\mathbb{R}^{}$，存在$N\in\mathbb{N}^+$使得当$n>N$时有$x_n>y_n$，若$\lim\limits_{n\to+\infty}x_n=-\infty$，则$\lim\limits_{n\to+\infty}y_n=-\infty$；
		\end{enumerate}
