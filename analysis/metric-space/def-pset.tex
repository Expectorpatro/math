...
\begin{theorem}[Comparison Test]\label{theo:ComparisonTest}
	...
	\begin{enumerate}
		...
		\item （上下极限形式）
		\begin{enumerate}
			\item 若$\sum\limits_{n=1}^{+\infty}b_n$收敛且$\varlimsup\frac{a_n}{b_n}=\gamma\in[0,+\infty)$，则$\sum\limits_{n=1}^{+\infty}a_n$收敛；
			\item 若$\sum\limits_{n=1}^{+\infty}b_n$发散且$\varliminf\frac{a_n}{b_n}=\gamma\in(0,+\infty]$，则$\sum\limits_{n=1}^{+\infty}a_n$发散。
		\end{enumerate}
		\item （极限形式）
		\begin{enumerate}
			\item 若$\sum\limits_{n=1}^{+\infty}b_n$收敛且$\lim\limits_{n\to+\infty}\frac{a_n}{b_n}=\gamma\in[0,+\infty)$，则$\sum\limits_{n=1}^{+\infty}a_n$收敛；
			\item 若$\sum\limits_{n=1}^{+\infty}b_n$发散且$\lim_{n\to+\infty}\frac{a_n}{b_n}=\gamma\in(0,+\infty]$，则$\sum\limits_{n=1}^{+\infty}a_n$发散。
		\end{enumerate}
	\end{enumerate}
\end{theorem}
\begin{proof}
