...
\begin{proof}
	...
	(1)必要性：假设该闭子集族的交集为空集。令$G_i=X\backslash F_i$，由\cref{prop:OpenClosedSet}(5)可知$\{G_i\}_{i\in I}$为开集族。由\cref{prop:SetOperation}(6)(4)(7)可得：
	\begin{equation*}
	...
	\begin{equation*}
		\underset{j=1}{\overset{n}{\cap}}F_{i_j}=\underset{j=1}{\overset{n}{\cap}}(X\backslash G_{i_j})=X\backslash\underset{j=1}{\overset{n}{\cup}}G_{i_j}\subseteq X\backslash A
	\end{equation*}
	...
	综合上两式可得：
	\begin{equation*}
		\underset{j=1}{\overset{n}{\cap}}F_{i_j}\subseteq(X\backslash A)\cap A=\varnothing
	\end{equation*}
	这与$\mathscr{F}$具有有限交性质矛盾。\par
	(2)充分性：设闭集$A$中任一具有有限交性质的闭子集族具有非空的交。设$\{G_i\}_{i\in I}$为$A$的任一开覆盖，令$F_i=A\backslash G_i$，因为$A$是闭集，由\cref{prop:SetOperation}(6)和\cref{prop:OpenClosedSet}(5)(6)可知$F_i$也是闭集。由\cref{prop:SetOperation}(6)(2)(7)可得：
	\begin{equation*}
