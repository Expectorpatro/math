...
\subsection{Gibbs不等式}
\begin{theorem}
	设$\varphi,\mu$是可测空间$(X,\mathscr{F})$上的概率测度，$\varphi\ll\mu$，根据\cref{theo:RandonNikodym}，有：
	\begin{inequality*}\label{ineq:Gibbs}
		\int_{X}\ln\frac{\dif\varphi}{\dif\mu}\dif\varphi\geqslant0
	\end{inequality*}
...
\begin{proof}
	...
	\begin{equation*}
		x\ln x\geqslant x-1
	\end{equation*}
	等号成立当且仅当$x=1$。取$x=\dfrac{\dif\varphi}{\dif\mu}$，由\cref{theo:RandonNikodym}和\cref{prop:MeasurableIntegral}(10)可得$\dfrac{\dif\varphi}{\dif\mu}\geqslant0\;$a.e.于$(X,\mathscr{F},\mu)$。根据\cref{prop:MeasurableIntegral}(7)(6)和\cref{lem:IntChangeOfMeasure}可得：
	\begin{gather*}
		\frac{\dif\varphi}{\dif\mu}\ln\frac{\dif\varphi}{\dif\mu}\geqslant\frac{\dif\varphi}{\dif\mu}-1\;\text{a.e.于}(A,\mathscr{F},\mu) \\
		\int_{X}\frac{\dif\varphi}{\dif\mu}\ln\frac{\dif\varphi}{\dif\mu}\dif\mu\geqslant\int_{X}\left(\frac{\dif\varphi}{\dif\mu}-1\right)\dif\mu \\
		\int_{X}\ln\frac{\dif\varphi}{\dif\mu}\dif\varphi\geqslant0
	\end{gather*}
