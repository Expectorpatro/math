...
\end{definition}
%\begin{derivation}
%	因为$\Sigma>0$，所以存在$\Sigma^{-\frac{1}{2}}$。令$y^*=\Sigma^{-\frac{1}{2}}y,\;X^*=\Sigma^{-\frac{1}{2}}\beta,\;\varepsilon^*=\Sigma^{-\frac{1}{2}}\varepsilon$，由\cref{prop:CovMat}(3)可知\cref{model:LinearModel}可化作：
%	\begin{equation*}
%		\begin{cases}
%			y^*=X^*\beta+\varepsilon^* \\
%			\operatorname{E}(\varepsilon^*)=\mathbf{0} \\
