...
\begin{proof}
	...
	\end{equation*}
	根据\cref{lem:AXTXAT}可知$A(X^{\top}X)^-A^{\top}$存在平方根阵及平方根阵的逆矩阵，由\cref{prop:MultiNormal}(2)可知：
	\begin{equation*}
...
\end{theorem}
\begin{proof}
	由\cref{theo:NormalLinearModelConfidenceEllipsoid}、\cref{lem:AXTXAT}与\cref{ineq:cauchy-schiwarz-rayleigh}可知：
	\begin{align*}
