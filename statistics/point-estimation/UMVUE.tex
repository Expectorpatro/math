...
\begin{proof}
	...
	\end{gather*}
	由\cref{prop:ExponentialFamily}(2)、\cref{prop:FrechetDifferential}(5)、\cref{prop:ExponentialFamily}(5)和\cref{prop:MeasurableIntegral}(6)可知：
	\begin{align*}
	...
	\end{equation*}\par
	因为$T$是统计量，所以根据\cref{prop:ExponentialFamily}(5)、\cref{prop:MeasurableIntegral}(6)和\cref{prop:CovMat}(6)可得：
	\begin{align*}
