...
\end{theorem}
\begin{proof}
	\textbf{(1)$\;\Sigma$已知：}因为$\Sigma>0$，所以$\Sigma^{-1},\Sigma^{-\frac{1}{2}}$存在\info{正定矩阵可逆}。在原价设成立的情况下，由\cref{theo:MatNormalLinearTransform}和\cref{theo:MultiVariateSamplingDist}(1)可知：
	\begin{equation*}
