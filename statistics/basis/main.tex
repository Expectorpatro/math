...
\begin{property}
	...
	\begin{enumerate}
		...
		\item 若$(X,\mathscr{A},\mathscr{P})$是可控的，则$(Y,\mathscr{B},\mathscr{P}f^{-1})$也可控\info{结论2和3来源于茆诗松高等数理统计，但现在怀疑结论不对}，其中$\mathscr{P}f^{-1}=\{Pf^{-1}:P\in\mathscr{P}\}$；
...
\input{statistics/basis/deltamethod.tex}
