...
\begin{proof}
	...
	任取$\seq{\theta}{n}\in\mathbb{R}^{+}$且$\sum\limits_{i=1}^{n}\theta_i=1$，$\seq{x}{n}\in E$，则：
	\begin{equation*}
...
\begin{property}
	...
	\begin{enumerate}
		\item $E$是仿射集当且仅当对任意的$n\in\mathbb{N}^+$，$\seq{\theta}{n}\in\mathbb{R}^{}$且$\sum\limits_{i=1}^{n}\theta_i=1$，$\seq{x}{n}\in\mathbb{R}^{n}$，元素：
		\begin{equation*}
			\theta_1x_1+\theta_2x_2+\cdots+\theta_nx_n
		\end{equation*}
		都在$E$中；
