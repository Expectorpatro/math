...
\begin{theorem}
	设对称阵$A\in M_n(\mathbb{R})$，其特征值记为$\lambda_i,\;i=1,2,\dots,n$。因为$A$是一个实对称阵，由\cref{prop:HermitianMatEigen}(3)可知存在正交矩阵$Q$使得$A=Q^{\top}\operatorname{diag}\{\seq{\lambda}{n}\}Q$。若$A>0$，由\cref{theo:PositiveDefinite}(3.5)可知$\lambda_i>0,\;i=1,2,\dots,n$，记：
	\begin{equation*}
		\varLambda^{-\frac{1}{2}}=\operatorname{diag}\{\lambda_1^{-\frac{1}{2}},\lambda_2^{-\frac{1}{2}},\dots,\lambda_n^{-\frac{1}{2}}\}
	\end{equation*}
	则：
...
\begin{proof}
	...
	\begin{equation*}
		QA^{-\frac{1}{2}}Q^{-1}=\varLambda^{-\frac{1}{2}}
	\end{equation*}
	即$\lambda_i^{-\frac{1}{2}}$为$A^{-\frac{1}{2}}$的特征值，而$\lambda_i>0$，由\cref{theo:PositiveDefinite}(3.5)可知$A^{\frac{1}{2}}>0$。\par
	(3)显然：
	\begin{equation*}
		(A^{-\frac{1}{2}})^{\top}=(Q^{\top}\varLambda^{-\frac{1}{2}} Q)^{\top}=Q^{\top}(\varLambda^{-\frac{1}{2}})^{\top}Q=Q^{\top}\varLambda^{-\frac{1}{2}}Q=A^{-\frac{1}{2}}
	\end{equation*}
